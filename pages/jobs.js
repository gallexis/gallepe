  ...
  return (
    <Layout title={title} page="jobs">
      ...
      <div className="card block">
        ...
        <h2>Vigie</h2>
        <p>
          <em>2020</em>-<em>present</em> <br /><br />
          Software developer at Vigie, a sales estimation platform for Amazon, ManoMano, and soon many others ...<br />
          I work on the creation of <strong>Go</strong> web crawlers,
          which are able to crawl efficiently through hundreds of thousands of pages per day,
          then extract pertinent information from these pages.<br />
          I'm also working on the front-end of Vigie, using a Next.js (React) framework, deployed on Vercel.
        </p>
        </a>
      </div>
      ...
      <div className="card fixed block">
        ...
        <p>
          ...
          per second. <br /> I was working on a Docker based environment, where tests
      ...
      <div className="card block">
        ...
        <p>
          ...
          security markets.<br />
          I worked on the conception & implementation of decoders which
